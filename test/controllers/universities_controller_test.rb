...
class UniversitiesControllerTest < ActionController::TestCase
  ...
  test "should create university" do
    assert_difference('University.count') do
      post :create, university: { city_id: @university.city_id, description: @university.description, name: @university.name }
    end
  ...
  test "should update university" do
    patch :update, id: @university, university: { city_id: @university.city_id, description: @university.description, name: @university.name }
    assert_redirected_to university_path(assigns(:university))
  end
